...
minimal GPU compute (local RTX 5070 Ti, 16GB VRAM, 15 min per experiment).
...
on a single GPU. Start with the simplest approach that could beat PID.`;
...
async function main() {
  ...
  console.log(`GPU: RTX 5070 Ti (16GB VRAM, 15 min max per experiment)`);
